...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'busquedalocacion',
          path: '/busquedalocacion',
          builder: (context, params) => BusquedalocacionWidget(),
        ),
        FFRoute(
          name: 'locaciones',
          path: '/locaciones',
          builder: (context, params) => LocacionesWidget(),
        ),
        FFRoute(
          name: 'paginadeperfil',
          path: '/paginadeperfil',
        ...
        FFRoute(
          name: 'fotografos',
          path: '/fotografos',
          builder: (context, params) => FotografosWidget(),
        ),
        FFRoute(
          name: 'misfavoritos',
          path: '/misfavoritos',
